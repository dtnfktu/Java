...
Для работы с форматом JSON существует несколько инструментов для Java.
При этом, необходимо для начала провести настройку конкретного пакета на конкретном ПК.
...
//-------------- вариант 1 - пасринг в массив массивов строк ----------------------------------------------
        ...
        System.out.println("Результат выполнения первого варианта:");
...
//------------- вариант 2 - пасринг в массив Мар ----------------------------------------------------------        
    ...
    // Конверирует JSON-строку в массив HashMap
